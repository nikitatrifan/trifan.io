...
class BGASlide extends React.Component {
  ...
  scrollHandler = () => {
    const percent = getNodeRelativeViewportPercentPosition(this.wrapper, true);
    ...
    return (
      <div ref={b => (this.wrapper = b)} className={classes.wrapper}>
        ...
        <div className={classes.images}>
          <div ref={b => (this.images[0] = b)} className={classes.images_col}>
            <img className={classes.image} src="/bga/1.png" alt="" />
            <img className={classes.image} src="/bga/2.png" alt="" />
          </div>
          <div
            ref={b => (this.images[1] = b)}
            className={classNames(classes.images_col, classes.image_col_second)}
          >
            <img className={classes.image} src="/bga/3.png" alt="" />
            <img className={classes.image} src="/bga/4.png" alt="" />
          </div>
          <div
            ref={b => (this.images[2] = b)}
            className={classNames(classes.images_col, classes.image_col_third)}
          >
            <img className={classes.image} src="/bga/5.png" alt="" />
          </div>
        </div>
      </div>
    );
