...
class Approach extends React.Component {
    ...
    spinnerBlockLeaveHandler = () =>
        this.setState({isSpinnerAnimated: false});
    spinnerBlockEnterHandler = () =>
        this.setState({isSpinnerAnimated: true});

    globeBlockLeaveHandler = () =>
        this.setState({isGlobeAnimated: false});
    globeBlockEnterHandler = () =>
        this.setState({isGlobeAnimated: true});
                            ...
                            <ComponentFadeIn delay={0.54}>
                                <div className={classes.col}>
                                    ...
                                    <Paragraph margin="medium" color={textColor}>
                                        No one likes to interact with things that don’t provide feedback.
                                        Imagine you use your turn signal at a left turn and nothing happens.
                                        You’d be stuck thinking something is wrong with your car, even if
                                        the feature is working perfect externally.
                                    </Paragraph>
                                </div>
                            </ComponentFadeIn>
                            <ComponentFadeIn delay={0.58}>
                                <div className={classes.col}>
                                    <Card>
                                        ...
                                        <Box justify="center" align="start" direction="column" className={classes.col_content}>
                                            <ButtonShadow>
                                                Explore more
                                            </ButtonShadow>
                                        </Box>
                                        <Paragraph margin="medium" color={textColor} size={3}>
                                            You feel that your mouse is over of the button because of hover animation. Try to click it.
                                        </Paragraph>
                                    </Card>
                                </div>
                            </ComponentFadeIn>
                            <ComponentFadeIn delay={0.62}>
                                <div className={classes.col}>
                                    <Card>
                                        ...
                                        <Box justify="center" align="start" direction="column" className={classes.col_content}>
                                            <ButtonBack color={textColor} text={(
                                        ...
                                        <Paragraph margin="medium" color={textColor} size={3}>
                                            The small movement of the arrow to the left side is showing us an actual meaning of the button.
                                        </Paragraph>
                                    </Card>
                                </div>
                            </ComponentFadeIn>
                            ...
                            <ComponentFadeIn delay={0.62}>
                                <div className={classes.col}>
                                    ...
                                    >
                                        ...
                                        <Paragraph margin="medium" color={textColor} size={3}>
                                            Any app have to avoid using preloaders anywhere.
                                            But if I had to — I’m using
                                            placeholders.
                                        </Paragraph>
                                    </Card>
                                </div>
