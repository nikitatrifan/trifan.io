              ...
              <div className={classes.text}>
                <div ref={b => (this.blocks[0] = b)}>
                  <Heading margin="medium" color={textColor} size={2}>
                    My name is Nikita Trifan and I’m a full-stack developer with good UX—UI feeling.
                  </Heading>
                </div>
                <div ref={b => (this.blocks[1] = b)}>
                  <Heading margin="medium" color={textColor} size={2}>
                    I believe that in a future all websites will works like my web apps — asynchronous
                    and interactive.
                  </Heading>
                </div>
                <div ref={b => (this.blocks[2] = b)}>
                  <Paragraph margin="medium" color={textColor}>
                    I’m always using the best practises and technologies to get best at developing time
                    user experience. My 2-3 years old works still relevant by performance speed and a
                    design at least to this day.
                  </Paragraph>
                </div>
              </div>
            </Box>
